function [t_data,ON_data_1_,ON_data_2_,ON_data_3_]  = Data_plot_20250306(num_total,Sample_number,t_ctr_min,F_ctr_min,t_ctr_baseline,F_ctr_baseline)
...
time_pts = [1,23,36,40;
            1,23,36,40;
            1,23,36,40]; % each time point indicates the first time point after adding each reagent
