...
idx_list = [2,21,length(Dose_list)];
...
for j=1:3
    ...
    ylim([0,lim_list(j)])
    if j==1
        title('D_{in} = '+string(Dose_list(idx_list(1))*D))
    end
    set(gca,'FontSize',20);
    ...
    ylim([0,lim_list(j)])
    if j==1
        title('D_{in} = '+string(Dose_list(idx_list(2))*D))
    end
    set(gca,'FontSize',20);
    lgd = legend; lgd.FontSize = 15;
    legend
    ...
    ylim([0,lim_list(j)])
    if j==1
        title('D_{in} = '+string(Dose_list(idx_list(3))*D))
    end
    set(gca,'FontSize',20);
    lgd = legend; lgd.FontSize = 15;
    legend
