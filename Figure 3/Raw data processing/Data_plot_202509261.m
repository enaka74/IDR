function [t_data,ON_data_1_,ON_data_2_,ON_data_3_]  = Data_plot_202509261(num_total,Sample_number,t_ctr_min,F_ctr_min,t_ctr_baseline,F_ctr_baseline)
...
time_pts = [1,55,80,85;
            1,55,80,85;
            1,55,80,85]; % each time point indicates the first time point after adding each reagent
