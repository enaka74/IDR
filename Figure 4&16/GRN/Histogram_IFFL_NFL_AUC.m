...
data_IFFL = readmatrix('IFFL_GRN_parameter_screening_RandomParameter_rescaled_yFloor_u=1.xlsx', ...
    "Sheet",sheetname,"range","B1:B10000");
data_NFL  = readmatrix('NFL_GRN_parameter_screening_RandomParameter_rescaled_yFloor_u=1.xlsx', ...
    "Sheet",sheetname,"range","B1:B10000");
