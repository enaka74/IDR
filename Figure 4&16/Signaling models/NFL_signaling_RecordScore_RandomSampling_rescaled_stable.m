function IDD_score_list_and_param = NFL_signaling_RecordScore_RandomSampling_rescaled_stable(N,u)
...
for idx=1:N
    IDD_score_list(idx,:) = main_IDD_1(param(idx,:),u);
end
...
function IDD_score = main_IDD_1(param,u)
    % Constants
    %u = 1;
