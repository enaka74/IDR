...
data_IFFL = readmatrix('IFFL_signaling_parameter_screening_RandomParameter_rescaled_stable_u=0.1.xlsx', ...
    "Sheet",sheetname,"range","B1:B10000");
data_NFL  = readmatrix('NFL_signaling_parameter_screening_RandomParameter_rescaled_stable_u=0.1.xlsx', ...
    "Sheet",sheetname,"range","B1:B10000");
