function IDD_create_mnMap_AUC(param_idx,param)
...
xticks([1 2 3 4 5 6])
yticks([1 2 3 4 5 6])
title('a=' + string(param(1)) + ', b=' + string(param(2)))
...
function dYdt = model_1_m_n(t, Y, param)
    a = param(1); b = param(2); m = param(3); n = param(4); r = param(5:5+m+n)'; u = param(end-1); D = param(end);
